...
/>
      ...
      <div className="ps-10 pe-10">
        <button onClick={sendMail} className="rounded-lg w-full h-10 text-white text-2xl hover:scale-105 hover:border hover:border-black bg-red-500">Pošalji</button>
      </div>
    </div>
  );
};
