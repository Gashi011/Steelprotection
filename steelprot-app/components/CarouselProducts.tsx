  ...
  return (
    <div className="max-w-[1000px] h-[540px] w-full m-auto py-16 px-4 relative group pt-0">
      ...
      >
        ...
        {/* Left Arrow */}
        <div className="absolute top-[360px] -translate-x-0 translate-y-[-50%] left-5 text-2xl rounded-full p-2 bg-black text-white coursor cursor-pointer hover:text-red-500 ">
          <BsChevronCompactLeft onClick={prevSlide} />
        </div>
        {/* Right arrow */}
        <div className="absolute top-[360px] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black text-white coursor cursor-pointer hover:text-red-500">
